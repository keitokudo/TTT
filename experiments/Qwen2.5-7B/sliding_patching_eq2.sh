...
EQUATION_STARTS=(25 18 15 7 0)
EQUATION_ENDS=(32 24 17 14 6)
...
cd $THIS_SCRIPT_DIR
zsh env_setup.sh
zsh ./scripts/prepro.sh ./configs/prepro_config_2step_random_edit_teacher_force_eq_2_test.jsonnet
...
for equation_id in $(seq 0 $((NUM_EQUATIONS - 1))); do
	...
	zsh ./scripts/test_sliding.sh \
	    ./configs/decode_test_2step_random_edit_teacher_force_sliding_eq_2_config.jsonnet 0 1 2
    done
done
