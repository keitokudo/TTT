...
local base_config = import "./decode_test_2step_distractor_config.jsonnet";
local model_config = import "./model_specific_config.jsonnet";

local test_data_config = import "./prepro_config_2step_distractor_general_fewshot_prompt_3formulas_probing_train.jsonnet";
