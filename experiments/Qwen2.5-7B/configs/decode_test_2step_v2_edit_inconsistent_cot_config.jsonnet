...
local train_data_config = import "./prepro_config_2step_train.jsonnet";
local valid_data_config = import "./prepro_config_2step_valid.jsonnet";
local test_data_config = import "./prepro_config_2step_v2_edit_inconsistent_cot_test.jsonnet";
...
base_config + {
  ...
  Decoding: super.Decoding + {
    ...
    source_key: test_data_config.source_key,
    gold_key: "original_answer",
  },
