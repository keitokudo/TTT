...
EQUATION_STARTS=(38 33 25 18 15 7 0)
EQUATION_ENDS=(44 37 32 24 17 14 6)
...
cd $THIS_SCRIPT_DIR
zsh env_setup.sh
zsh ./scripts/prepro.sh ./configs/prepro_config_2step_random_edit_teacher_force_eq_4_test.jsonnet
