...
local train_data_config = import "./prepro_config_1step_train.jsonnet";
local valid_data_config = import "./prepro_config_1step_valid.jsonnet";
local test_data_config = import "./prepro_config_1step_test.jsonnet";
