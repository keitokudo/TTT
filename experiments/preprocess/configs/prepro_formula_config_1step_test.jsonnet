...
local valid_data_config = import "./prepro_formula_config_1step_valid.jsonnet";
local train_data_config = import "./prepro_formula_config_1step_train.jsonnet";

valid_data_config + {
  config_file_path: "%s/data_configs/test_1step_config.jsonnet" % [
    CURRENT_DIR,
  ],
  output_dir: "%s/%s/raw/test_1step" % [
    DATASET_DIR,
    std.extVar("TAG"),
  ],
  number_of_data: 2000,
