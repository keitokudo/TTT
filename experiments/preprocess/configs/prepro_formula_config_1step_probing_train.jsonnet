...
local test_data_config = import "./prepro_formula_config_1step_test.jsonnet";

test_data_config + {
  config_file_path: "%s/data_configs/probing_train_1step_config.jsonnet" % [
    CURRENT_DIR,
  ],
  output_dir: "%s/%s/raw/probing_train_1step" % [
    DATASET_DIR,
    std.extVar("TAG"),
  ],
