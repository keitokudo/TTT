...
local test_data_config = import "./prepro_formula_config_3step_test.jsonnet";

test_data_config + {
  config_file_path: "%s/data_configs/probing_train_3step_config.jsonnet" % [
    CURRENT_DIR,
  ],
  output_dir: "%s/%s/raw/probing_train_3step" % [
    DATASET_DIR,
    std.extVar("TAG"),
  ],
