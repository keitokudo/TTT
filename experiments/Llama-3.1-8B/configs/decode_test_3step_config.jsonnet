...
local train_data_config = import "./prepro_config_3step_train.jsonnet";
local valid_data_config = import "./prepro_config_3step_valid.jsonnet";
local test_data_config = import "./prepro_config_3step_test.jsonnet";
